...
def test_category_bounds():
    ...
    valid_laptop = RawPriceRecord(sku="L1", name="Laptop 1", price=999.99, category="laptop")
    cheap_laptop = RawPriceRecord(sku="L2", name="Laptop 2", price=50.0, category="laptop")
    expensive_laptop = RawPriceRecord(sku="L3", name="Laptop 3", price=6000.0, category="laptop")
