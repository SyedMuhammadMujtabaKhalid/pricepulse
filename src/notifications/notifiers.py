...
class SMTPNotifier(BaseNotifier):
    ...
    def __init__(self, host: str, port: int, username: str, password: str, to_address: str):
        self.host = host
        self.port = port
    ...
    def send(self, alert: Alert) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                log.error("notifier.telegram.failed", status=response.status_code, body=response.text)
                return False
        except Exception as e:
    ...
    def send(self, alert: Alert) -> bool:
        ...
        try:
            ...
            if response.status_code in (200, 204):
                ...
                log.error("notifier.discord.failed", status=response.status_code, body=response.text)
                return False
        except Exception as e:
